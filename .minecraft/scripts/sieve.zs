...
val SluiceReMap = {
	...
	<magneticraft:rocky_chunks:2> : [<magneticraft:chunks:2> % 100,<thermalfoundation:material:1> % 15,<minecraft:glowstone_dust> % 1],
...
val SieveReMap = {
	...
	<magneticraft:rocky_chunks:2> : [<magneticraft:chunks:2> % 100,<thermalfoundation:material:1> % 25,<minecraft:glowstone_dust> % 3],
